...
#Projection of Y (black) on the model space is the sam of projections on basis vectors
...
#Projection of Y (black) on X_X_bar is Y_hat-Y_bar (green)
head(cbind(projYonX_X_bar=projYonX_X_bar,Y_hatMinusY_bat=Y_hat-Y_bar))
